...
public class WarByArrays {
    ...
    public WarByArrays(boolean isShuffled) {
        ...
        while (!(deck.isEmpty())) {
            ...
            System.out.print("No.of cards in hand1: " 
                + hand1.size()); 
            System.out.println("No.of cards in hand2: " 
                + hand2.size());
        }
    }
    ...
    public void play() {
        ...
        while (!(hand1.isEmpty() || hand2.isEmpty())) {
            ...
            System.out.print("In round " + count 
                    + " No.of cards in hand1: " + hand1.size());
            System.out.println("No.of cards in hand2: "
                    + hand2.size());
            count++;
        }
    ...
    public void playRound() {
        try {
            ...
            System.out.print("No.of (cards in hand1)=" 
                    + hand1.size());
            System.out.print(" No.of(cards in hand2)=" 
                    + hand2.size());
            System.out.print(" No.of(cards in stack1)=" 
                    + stack1.size());
            System.out.println(" No.of(cards in stack2)=" 
                    + stack2.size());
